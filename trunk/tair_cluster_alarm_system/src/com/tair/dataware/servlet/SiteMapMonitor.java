 ...
 */
public class SiteMapMonitor extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	private static final Log log = LogFactory.getLog(SiteMapMonitor.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(allgroups.size()==1){
				...
				if(bar.getMonitorUrlbase()!=null){
					response.sendRedirect(bar.getMonitorUrlbase());
					return ;
				}
			} else {
