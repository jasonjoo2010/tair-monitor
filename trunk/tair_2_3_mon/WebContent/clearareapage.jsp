...
<p>
For the sake of consistency, please <a href="querypage.jsp">query a key</a> before clear area !! <br>
Under either of the following two conditions, you can clear a area: <br>
[1]. this is a test cluster                      <br>
[2]. this is a rdb cluster and you have a passwd <br>
</p>
<div id="form-ct"></div> 
</center>
</body>
